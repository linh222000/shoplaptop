                    ...
                    <?php 
                        ...
                        ?>
                            <div class="row align-items-center latest_product_inner">
                                ...
                                ?>
                                    <div class="col-lg-4 col-sm-6" style="height: 500px;">
                                        <div class="single_product_item single_product" <?= $row['id'] ?> >
                                        <a href="detail.php?id=<?= $row['id'] ?>" >
                                            <img src="img/product/<?= $row['anh1'] ?>" style="width: 230px;height: 230px;margin-left: 16px;" alt="">
                                        </a>
                                            <div class="single_product_text">
                                                <h4 style="font-size: 16px"><?= $row['ten'] ?></h4>
                                                <h3 style="color: red;"><?= number_format($row['gia']) .' ' . 'vnđ' ?></h3>
                                                <p><a href="detail.php?id=<?= $row['id'] ?>" style="font-size: 14px">Xem chi tiết</a></p>
                                                <a href="detail.php?id=<?= $row['id'] ?>">+ Thêm vào giỏ</a>
                                            </div>
                                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="section_tittle text-center">
                        <h3 style="font-weight: 600;">Sản Phẩm Bán Chạy</h3>
                    </div>
                </div>
            </div>
                    ...
                    ?>
                        <div class="single_product_item">
                            ...
                            <div class="single_product_text">
                                <a href="detail.php?id=<?= $item['id'] ?>" >
                                <h4><?= $item['ten'] ?></h4>
                                <h3 style="color: red;"><?= number_format($item['gia']) . ' ' . 'vnđ' ?></h3>
                                </a>
                            </div>
                        </div>
                    <?php
